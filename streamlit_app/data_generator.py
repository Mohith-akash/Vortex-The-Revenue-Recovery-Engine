...
PRODUCTS = [
    # Electronics
    {"id": "ELEC001", "name": "MacBook Pro 16 M3", "price": 2499.00, "category": "Electronics", "popularity": 0.15},
    {"id": "ELEC002", "name": "iPhone 15 Pro Max", "price": 1199.00, "category": "Electronics", "popularity": 0.18},
    {"id": "ELEC003", "name": "Sony WH-1000XM5 Headphones", "price": 349.00, "category": "Electronics", "popularity": 0.12},
    {"id": "ELEC004", "name": "iPad Air M2", "price": 599.00, "category": "Electronics", "popularity": 0.10},
    {"id": "ELEC005", "name": "Samsung 65\" OLED TV", "price": 1799.00, "category": "Electronics", "popularity": 0.06},
    {"id": "ELEC006", "name": "Apple Watch Ultra 2", "price": 799.00, "category": "Electronics", "popularity": 0.08},
    {"id": "ELEC007", "name": "AirPods Pro 2", "price": 249.00, "category": "Electronics", "popularity": 0.14},
    {"id": "ELEC008", "name": "PlayStation 5", "price": 499.00, "category": "Electronics", "popularity": 0.09},
    
    # Fashion
    {"id": "FASH001", "name": "Nike Air Jordan 1 Retro", "price": 180.00, "category": "Fashion", "popularity": 0.16},
    {"id": "FASH002", "name": "Lululemon Align Leggings", "price": 98.00, "category": "Fashion", "popularity": 0.11},
    {"id": "FASH003", "name": "Ray-Ban Aviator Classic", "price": 161.00, "category": "Fashion", "popularity": 0.08},
    {"id": "FASH004", "name": "Canada Goose Expedition Parka", "price": 1295.00, "category": "Fashion", "popularity": 0.04},
    {"id": "FASH005", "name": "Adidas Ultraboost 23", "price": 190.00, "category": "Fashion", "popularity": 0.10},
    {"id": "FASH006", "name": "Gucci GG Marmont Bag", "price": 2300.00, "category": "Fashion", "popularity": 0.03},
    
    # Home & Kitchen
    {"id": "HOME001", "name": "Dyson V15 Detect Vacuum", "price": 649.00, "category": "Home", "popularity": 0.09},
    {"id": "HOME002", "name": "Vitamix A3500 Blender", "price": 649.00, "category": "Home", "popularity": 0.05},
    {"id": "HOME003", "name": "Nespresso Vertuo Plus", "price": 179.00, "category": "Home", "popularity": 0.12},
    {"id": "HOME004", "name": "KitchenAid Stand Mixer", "price": 379.00, "category": "Home", "popularity": 0.07},
    {"id": "HOME005", "name": "Instant Pot Duo Plus", "price": 89.00, "category": "Home", "popularity": 0.13},
    {"id": "HOME006", "name": "Roomba j7+ Robot Vacuum", "price": 799.00, "category": "Home", "popularity": 0.06},
    
    # Sports & Fitness
    {"id": "SPRT001", "name": "Peloton Bike+", "price": 2495.00, "category": "Sports", "popularity": 0.04},
    {"id": "SPRT002", "name": "Optimum Nutrition Protein 5lb", "price": 64.99, "category": "Sports", "popularity": 0.15},
    {"id": "SPRT003", "name": "Theragun Pro", "price": 449.00, "category": "Sports", "popularity": 0.06},
    {"id": "SPRT004", "name": "Yeti Rambler 30oz", "price": 38.00, "category": "Sports", "popularity": 0.17},
    {"id": "SPRT005", "name": "Hydro Flask 32oz", "price": 44.95, "category": "Sports", "popularity": 0.14},
]
...
class Customer:
    ...
    @classmethod
    def generate(cls, archetype: Optional[str] = None, name: Optional[str] = None):
...
class ShoppingSession:
    ...
    @classmethod
    def generate(cls, customer: Customer, product: Optional[dict] = None):
        """Create a new shopping session."""
        archetype_config = ARCHETYPES[customer.archetype]
        product = product or random.choices(
            PRODUCTS, 
        ...
        return cls(
            ...
            session_duration=int(random.gauss(
...
if __name__ == "__main__":
    ...
    for event in events[:3]:
        print(f"  {event['event_type']}: {event['user_name']} - {event['product_name']} (${event['cart_total']})")
